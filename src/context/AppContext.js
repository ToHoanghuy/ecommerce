...
export const AppProvider = ({ children }) => {
  ...
  useEffect(() => {
    ...
    if (state.searchTerm) {
      filtered = filtered.filter(course =>
        ...
        course.shortDescription.toLowerCase().includes(state.searchTerm.toLowerCase()) ||
  ...
  }, [state.courses, state.searchTerm, state.selectedCategory, state.selectedPriceRange]);
